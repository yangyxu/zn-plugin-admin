	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'warp', style: { width: 640, backgroundColor: '#FFF', padding: 20 } },
					this.state.user ? React.createElement(
						...
						this.state.user.actived ? React.createElement(
							'div',
							{ style: { padding: 10 } },
							'\u60A8\u8D26\u53F7\u5DF2\u7ECF\u6FC0\u6D3B, \u8BF7\u52FF\u91CD\u590D\u64CD\u4F5C\u3002'
						) : React.createElement(
							'div',
							{ style: { padding: 10 } },
							'\u606D\u559C\u60A8, \u60A8\u7684\u8D26\u53F7\u6210\u529F\u6FC0\u6D3B\uFF0C\u7CFB\u7EDF\u5DF2\u628A\u767B\u5F55\u4FE1\u606F\u53D1\u9001\u5230\u60A8\u6FC0\u6D3B\u90AE\u7BB1(',
							this.state.user.email,
							')\u3002'
						),
						React.createElement(zn.react.Button, { onClick: function onClick() {
								return zn.react.session.jump('/zn.plugin.admin/login');
							}, style: { margin: 10 }, text: '\u70B9\u51FB\u767B\u5F55' })
					) : React.createElement(
						'div',
						null,
						React.createElement(zn.react.DataLoader, { content: '\u9A8C\u8BC1\u4E2D...', loader: 'timer' })
					)
				)
			),
			React.createElement(
