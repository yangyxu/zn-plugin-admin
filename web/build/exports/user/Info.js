		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						this.state.isSelf && React.createElement(
							'span',
							{ onClick: this.__update, className: 'last-logintime' },
						...
						this.state.isSelf && React.createElement(
							...
							'\u4EE3\u7406\u4EBA\uFF1A',
							this.state.info.agents_convert
						),
						this.state.info.zn_note && React.createElement(
							'div',
							{ className: 'item' },
				...
				React.createElement(
					zn.react.Card,
					{ title: '\u90E8\u95E8\u53CA\u89D2\u8272' },
					React.createElement(zn.plugin.admin.RoleSelector, { disabled: true, value: this.state.info.role_ids })
				)
			)
		);
	}
