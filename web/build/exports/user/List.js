...
module.exports = React.createClass({
	...
	getInitialState: function getInitialState() {
		return {
			...
			items: [{ title: '用户名', name: 'name', width: 120 }, { title: '邮箱', name: 'email', width: 140 }, { title: '手机号', name: 'phone', width: 120 }, { title: '角色', name: 'role_ids_convert', width: 120 }, { title: '代理人', name: 'agents_convert', width: 120 }, { title: '地址', name: 'address', width: 200 }, { title: '说明', name: 'zn_note' }],
