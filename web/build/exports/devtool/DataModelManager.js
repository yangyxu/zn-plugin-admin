		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'i-header' },
					this.props.method && React.createElement(
						'span',
						{ className: 'method' },
						this.props.method
					),
...
module.exports = React.createClass({
	...
	getInitialState: function getInitialState() {
		return {
			...
			apis: [],
			app: null,
			toolbarItems: [{ text: '更新代码', name: 'update.code', icon: 'fa-cloud-download', style: { marginRight: 5 } }, { text: '重启', name: 'restart', status: 'danger', icon: 'fa-play-circle', style: { marginRight: 5 } }]
		};
	},
	...
	__renderApps: function __renderApps() {
		return React.createElement(
			...
			this.state.apps.map(function (app, index) {
				...
				return React.createElement(
					'li',
					{ key: index, className: "app " + (this.state.app == app ? 'curr' : ''), onClick: function onClick() {
	...
	__renderApis: function __renderApis() {
		return React.createElement(
			...
			this.state.apis.map(function (api, index) {
				return React.createElement(API, _extends({ key: index }, api));
			}.bind(this))
		);
	},
	...
	render: function render() {
		return React.createElement(
			zn.react.Page,
			{ className: 'zn-plugin-admin-devtool-server-manager', title: '\u670D\u52A1\u5668API\u7BA1\u7406', toolbarItems: this.state.toolbarItems, onToolbarClick: this.__onToolbarClick },
			React.createElement(
				'div',
