...
module.exports = React.createClass({
	...
	getInitialState: function getInitialState() {
		return {
			...
			}, { title: '链接', type: 'Menu', data: Object.keys(zn.react.app._relativeRouters), name: 'url' }, { title: '路径', type: 'Input', name: 'path' }, { title: '图标', type: 'RichSelector', selector: zn.plugin.admin.FontAwesomeIcons, textRender: function textRender(text) {
	...
	__rightRender: function __rightRender(data) {
		...
		return React.createElement(MenuInfo, _extends({}, this.state, { data: data }));
	},
	render: function render() {
		return React.createElement(TreeModelView, _extends({}, this.state, { rightRender: this.__rightRender }));
	}
});