...
var _exports = React.createClass({
	...
	__onMenuClick: function __onMenuClick() {
		zn.modal.open(React.createElement(NavigationBar, { onMenuItemClick: function onMenuItemClick() {
				return zn.modal.close();
			}, style: { backgroundColor: '#000', overflow: 'auto' }, data: this.state.menus }), {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'head-left', title: '\u8DF3\u8F6C\u4E3B\u9875\u9762', onClick: this.__onCompanyClick },
						React.createElement(
							'div',
							{ className: 'wap' },
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('img', { 'data-tooltip': '\u67E5\u770B\u6211\u7684\u4E2A\u4EBA\u4FE1\u606F', src: zn.http.fixURL(zn.react.session.json().avatar_img) || './images/DefaultAvatar.png' })
							),
							React.createElement(
								'span',
								{ className: 'name' },
							...
							React.createElement('i', { className: 'fa fa-angle-down', onClick: this.__onSessionClick })
						),
						React.createElement(
							'div',
							{ className: 'icons' },
