...
module.exports = React.createClass({
	...
	__itemContentRender: function __itemContentRender(value, item) {
		...
		if (!_result) {
			_result = React.createElement(
				'span',
				null,
				value.icon && React.createElement('i', { style: { margin: 5 }, className: 'fa ' + value.icon }),
	...
	render: function render() {
		return React.createElement(zn.react.Tree, _extends({ ref: 'tree' }, this.props, {
