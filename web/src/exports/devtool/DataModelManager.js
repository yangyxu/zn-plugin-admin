...
module.exports = React.createClass({
	...
	render:function(){
		return (
			<zn.react.Page className="zn-plugin-admin-devtool-server-manager" title="服务器API管理" toolbarItems={this.state.toolbarItems} onToolbarClick={this.__onToolbarClick} >
