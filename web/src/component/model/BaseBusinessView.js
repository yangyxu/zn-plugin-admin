...
module.exports = React.createClass({
	...
	getInitialState: function () {
		return {
			...
			currItem: null,
			toolbarItems: [
				{ text: '新建项目', name: 'addItem', icon: 'fa-plus' },
				{ text: '编辑项目', name: 'updateItem', icon: 'fa-edit' },
				{ text: '删除项目', name: 'deleteItem', icon: 'fa-remove' }
			]
		}
	},
	...
	__addItem: function (pid){
		zn.dialog({
			...
			content: <zn.react.Form
				...
				btns={[
					{text: '新建项目', icon: 'fa-plus', type: 'submit', float: 'right', style: { marginRight:0 }},
